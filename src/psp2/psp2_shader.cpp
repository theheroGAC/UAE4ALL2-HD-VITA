...
PSP2Shader::PSP2Shader(Shader shaderType) {
    ...
    switch (shaderType) {
        ...
        case Shader::FXAA:
            ...
            break;
        case Shader::CRT_EASYMODE:
            shader = vita2d_create_shader((SceGxmProgram *) texture_v, (SceGxmProgram *) crt_easymode_f);
            break;
        case Shader::BICUBIC:
            shader = vita2d_create_shader((SceGxmProgram *) texture_v, (SceGxmProgram *) bicubic_f);
            break;
        case Shader::XBR_2X:
            shader = vita2d_create_shader((SceGxmProgram *) xbr_2x_v, (SceGxmProgram *) xbr_2x_f);
            break;
        case Shader::GTU:
            shader = vita2d_create_shader((SceGxmProgram *) gtu_v, (SceGxmProgram *) gtu_f);
            break;
        default:
    ...
    if (shader != NULL && shader->vertexProgram != NULL && shader->fragmentProgram != NULL) {
